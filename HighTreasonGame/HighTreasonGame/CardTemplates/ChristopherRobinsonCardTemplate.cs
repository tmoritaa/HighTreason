...
namespace HighTreasonGame
{
    ...
    public class ChristopherRobinsonCardTemplate : CardTemplate
    {
        public ChristopherRobinsonCardTemplate()
            : base("Christopher Robinson", 4, Player.PlayerSide.Prosecution, true)
        { }
