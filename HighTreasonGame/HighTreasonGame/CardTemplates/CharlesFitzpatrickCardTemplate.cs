...
namespace HighTreasonGame
{
    ...
    public class CharlesFitzpatrickCardTemplate : CardTemplate
    {
        public CharlesFitzpatrickCardTemplate()
            : base("Charles Fitzpatrick", 4, Player.PlayerSide.Defense, true)
        { }
